class ParseErrors {
  static final Map<int, String> _error = {
    ...
    101: 'Utilizador/a ou senha inválidos',
    ...
    155: 'O aplicativo excedeu o limite de solicitação (RequestLimitExceeded)',
    160: 'Evento inválido (InvalidEventName)',
    200: 'Nome do/a utilizador/a não foi preenchido',
    ...
    205: 'E-mail não está registado',
    206: 'Sessão inválida para alteração do/a utilizador/a (SessionMissing)',
    207: 'Utilizador/a só pode ser criado/a via Signup (MustCreateUserThroughSignup)',
    208: 'A conta informada já está vinculada com outro/a utilizador/a',
    209: 'Sessão inválida (InvalidSessionToken)',
    250: 'Utilizador/a não pode ser vinculado a uma conta porque o ID não foi localizado (InvalidSessionToken)',
    251: 'Utilizador/a com conta vinculada está com sessão inválida (InvalidLinkedSession)',
